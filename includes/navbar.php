                ...
                <div class="topbar d-flex align-items-center">
                    <nav class="navbar navbar-expand gap-3">
                        <div class="topbar-logo-header d-none d-lg-flex">
                            <div class="">
                                <img src="<?=urlOf('assets/images/logo.png')?>" width="110px">
                                <!-- <img src="<?=urlOf('assets/images/logo.jpg')?>" class="logo-icon" alt="logo icon"> -->
                            </div>
                            <div class="">
                                <h4 class="logo-text">StayComfort</h4>
                            </div>
                        </div>
                        ...
                        <div class="user-box dropdown px-3">
                            <a class="d-flex align-items-center nav-link dropdown-toggle gap-3 dropdown-toggle-nocaret"
                                ...
                                <img src="<?= urlOf('assets/images/avatars/avatar-2.png')?>" class="user-img"
                                    alt="user avatar">
                                <div class="user-info">
