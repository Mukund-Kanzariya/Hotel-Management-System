...
define("BASE_DIR", $_SERVER['DOCUMENT_ROOT'] . "/HotelManagementSystem");
define("BASE_URL", "/HotelManagementSystem");

date_default_timezone_set('Asia/Kolkata');

$connection = new PDO("mysql:host=localhost;port=3306;dbname=hotelmanagement", "root", "");
